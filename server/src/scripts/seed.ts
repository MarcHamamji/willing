...
`.execute(database);
  ...
  const postings = await database.insertInto('organization_posting')
    .values([
      ...
      // Crisis Postings - Urgent Emergency Response
      {
        ...
        latitude: 33.85,
        longitude: 35.52,
        location_name: 'Beirut Emergency Center',
        max_volunteers: 50,
        start_timestamp: new Date(`${nowYear}-02-01T06:00:00Z`),
        end_timestamp: new Date(`${nowYear}-02-07T18:00:00Z`),
        minimum_age: 16,
        automatic_acceptance: true,
        is_closed: false,
      },
      {
        ...
        latitude: 33.35,
        longitude: 35.48,
        location_name: 'Saida Medical Field Hospital',
        max_volunteers: 30,
        start_timestamp: new Date(`${nowYear}-02-03T00:00:00Z`),
        end_timestamp: undefined,
        minimum_age: 18,
        automatic_acceptance: false,
        is_closed: false,
      },
      {
        ...
        latitude: 34.42,
        longitude: 35.85,
        location_name: 'Tripoli Refugee Center',
        max_volunteers: 40,
        start_timestamp: new Date(`${nowYear}-02-05T08:00:00Z`),
        end_timestamp: new Date(`${nowYear}-02-15T20:00:00Z`),
        minimum_age: 16,
        automatic_acceptance: true,
        is_closed: false,
      },
      {
        ...
        latitude: 33.92,
        longitude: 35.45,
        location_name: 'Beirut Disaster Zone',
        max_volunteers: 60,
        start_timestamp: new Date(`${nowYear}-02-08T05:00:00Z`),
        end_timestamp: new Date(`${nowYear}-02-20T22:00:00Z`),
        minimum_age: 18,
        automatic_acceptance: true,
        is_closed: false,
      },
      {
        ...
        latitude: 33.38,
        longitude: 35.46,
        location_name: 'Saida Emergency Shelter',
        max_volunteers: 25,
        start_timestamp: new Date(`${nowYear}-02-10T14:00:00Z`),
        end_timestamp: new Date(`${nowYear}-02-12T18:00:00Z`),
        minimum_age: 16,
        automatic_acceptance: false,
        is_closed: false,
      },
      {
        ...
        latitude: 34.45,
        longitude: 35.83,
        location_name: 'Tripoli Power Emergency Hub',
        max_volunteers: 35,
        start_timestamp: new Date(`${nowYear}-02-12T07:00:00Z`),
        end_timestamp: undefined,
        minimum_age: 16,
        automatic_acceptance: true,
        is_closed: false,
      ...
      // Special Crisis: Ethical Rescue Operation
      {
        ...
        latitude: 34.25,
        longitude: 36.05,
        location_name: 'Qadisha Valley Rescue Site',
        max_volunteers: 12,
        start_timestamp: new Date(`${nowYear}-02-15T04:00:00Z`),
        end_timestamp: new Date(`${nowYear}-02-16T12:00:00Z`),
        minimum_age: 21,
        automatic_acceptance: false,
        is_closed: false,
      },
  ...
  await database.insertInto('posting_skill').values([
    ...
    // Crisis Posting Skills
    { posting_id: postingByTitle.get('Flood Relief Distribution')!, name: 'Emergency Response' },
    { posting_id: postingByTitle.get('Flood Relief Distribution')!, name: 'Distribution' },
    { posting_id: postingByTitle.get('Flood Relief Distribution')!, name: 'Logistics' },
    { posting_id: postingByTitle.get('Flood Relief Distribution')!, name: 'Teamwork' },
    { posting_id: postingByTitle.get('Flood Relief Distribution')!, name: 'Physical Stamina' },
    { posting_id: postingByTitle.get('Flood Relief Distribution')!, name: 'Crisis Management' },

    { posting_id: postingByTitle.get('Medical Emergency Response')!, name: 'First Aid' },
    { posting_id: postingByTitle.get('Medical Emergency Response')!, name: 'Patient Care' },
    { posting_id: postingByTitle.get('Medical Emergency Response')!, name: 'Emergency Response' },
    { posting_id: postingByTitle.get('Medical Emergency Response')!, name: 'Communication' },
    { posting_id: postingByTitle.get('Medical Emergency Response')!, name: 'Compassion' },
    { posting_id: postingByTitle.get('Medical Emergency Response')!, name: 'Stress Management' },

    { posting_id: postingByTitle.get('Refugee Camp Support')!, name: 'Cultural Sensitivity' },
    { posting_id: postingByTitle.get('Refugee Camp Support')!, name: 'Translation' },
    { posting_id: postingByTitle.get('Refugee Camp Support')!, name: 'Emotional Support' },
    { posting_id: postingByTitle.get('Refugee Camp Support')!, name: 'Registration' },
    { posting_id: postingByTitle.get('Refugee Camp Support')!, name: 'Multilingual' },
    { posting_id: postingByTitle.get('Refugee Camp Support')!, name: 'Adaptability' },

    { posting_id: postingByTitle.get('Earthquake Aftermath Aid')!, name: 'Heavy Lifting' },
    { posting_id: postingByTitle.get('Earthquake Aftermath Aid')!, name: 'Debris Removal' },
    { posting_id: postingByTitle.get('Earthquake Aftermath Aid')!, name: 'Shelter Construction' },
    { posting_id: postingByTitle.get('Earthquake Aftermath Aid')!, name: 'Safety Awareness' },
    { posting_id: postingByTitle.get('Earthquake Aftermath Aid')!, name: 'Physical Strength' },
    { posting_id: postingByTitle.get('Earthquake Aftermath Aid')!, name: 'Disaster Response' },

    { posting_id: postingByTitle.get('Fire Evacuation Support')!, name: 'Crisis Counseling' },
    { posting_id: postingByTitle.get('Fire Evacuation Support')!, name: 'Housing Coordination' },
    { posting_id: postingByTitle.get('Fire Evacuation Support')!, name: 'Family Support' },
    { posting_id: postingByTitle.get('Fire Evacuation Support')!, name: 'Resource Management' },
    { posting_id: postingByTitle.get('Fire Evacuation Support')!, name: 'Communication' },
    { posting_id: postingByTitle.get('Fire Evacuation Support')!, name: 'Problem Solving' },

    { posting_id: postingByTitle.get('Power Outage Emergency Aid')!, name: 'Technical Skills' },
    { posting_id: postingByTitle.get('Power Outage Emergency Aid')!, name: 'Generator Operation' },
    { posting_id: postingByTitle.get('Power Outage Emergency Aid')!, name: 'Electrical Safety' },
    { posting_id: postingByTitle.get('Power Outage Emergency Aid')!, name: 'Communication' },
    { posting_id: postingByTitle.get('Power Outage Emergency Aid')!, name: 'Coordination' },
    { posting_id: postingByTitle.get('Power Outage Emergency Aid')!, name: 'Adaptability' },

    // Special Crisis: Marc Hamamji Rescue Operation
    { posting_id: postingByTitle.get('Marc Hamamji Rescue Operation')!, name: 'Search and Rescue' },
    { posting_id: postingByTitle.get('Marc Hamamji Rescue Operation')!, name: 'Mountain Climbing' },
    { posting_id: postingByTitle.get('Marc Hamamji Rescue Operation')!, name: 'First Aid' },
    { posting_id: postingByTitle.get('Marc Hamamji Rescue Operation')!, name: 'Navigation' },
    { posting_id: postingByTitle.get('Marc Hamamji Rescue Operation')!, name: 'Emergency Response' },
    { posting_id: postingByTitle.get('Marc Hamamji Rescue Operation')!, name: 'Physical Fitness' },
  ]).execute();
